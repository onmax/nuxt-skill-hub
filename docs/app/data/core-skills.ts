...
export const coreSkills: CoreSkill[] = [
  ...
  { id: 'disambiguation-packs', title: 'Disambiguation Packs', description: 'Focused Nuxt packs help agents pick the right framework API before they fall back to generic Vue patterns', icon: 'i-lucide-layers-3', tag: 'core' },
  { id: 'vue-guidance', title: 'Vue Guidance', description: 'A sibling Vue skill covers SFC structure, reactivity, props/emits, and composables after the Nuxt decision is settled', icon: 'i-lucide-file-code-2', tag: 'core' },
  ...
  { id: 'module-authored', title: 'Module Delta Skills', description: 'Each module adds scoped guidance on top of the Nuxt packs instead of replacing broad framework rules', icon: 'i-lucide-puzzle', tag: 'modules' },
